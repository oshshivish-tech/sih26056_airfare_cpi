...
export const MOCK_CPI_HISTORICAL: CPIIndexPoint[] = [
  ...
  { date: '2026-09', periodLabel: 'Sep 2026 (Live - 19 Sep)', jevonsIndex: 111.4, dutotIndex: 112.5, weightedLaspeyresIndex: 111.0, officialMoSPICPIBaseline: 109.5, sampleCount: 25400, leadTimeFilter: 'ALL', yoyInflationRate: 6.9, momInflationRate: 1.5 },
...
export const MOCK_DAILY_CPI: DailyFarePoint[] = [
  ...
  { date: '2026-09-19', dayLabel: '19 Sep (Sat - Today)', dailyJevonsIndex: 109.6, dailyAvgFare: 5314, movingAverage7d: 5364, scrapedQuotesCount: 3650, isWeekend: false }
];
